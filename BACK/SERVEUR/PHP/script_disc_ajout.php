...
try {
    ...
    $requete = $db->prepare("INSERT INTO disc (disc_title, disc_year, disc_genre, disc_label, disc_price, disc_picture)
    VALUES (:disc_title, :disc_year, :disc_genre, :disc_label, :disc_price, :disc_picture);");
